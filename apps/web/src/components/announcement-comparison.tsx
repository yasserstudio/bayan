...
export function AnnouncementComparison() {
  return (
    <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center gap-3 sm:gap-5 md:gap-8 max-w-4xl mx-auto" aria-hidden="true">
      {/* Forgeable version */}
      <div className="w-[160px] sm:flex-1 sm:w-auto sm:max-w-[220px] md:max-w-[260px] flex flex-col items-center">
