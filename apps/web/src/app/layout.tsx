  ...
  "@graph": [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        {
          "@type": "Question",
          name: "هذا غير ديمو — كيفاش يفيدني دوك؟",
          acceptedAnswer: {
            "@type": "Answer",
            text: "الديمو يوريك كيفاش النظام يخدم. دوك الأهم هو إنك تفهم الفكرة وتشاركها — كل ما بزاف ناس عرفوها، كل ما قربنا من التطبيق الحقيقي.",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "النسخة الثانية غادي تخدم ببيانات حقيقية من المواقع الرسمية تاع الوزارات. نخدمو عليها دوك.",
          },
        },
      ],
    },
